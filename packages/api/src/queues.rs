...
use queue_core::{Queue, QueueId};
use dioxus::prelude::*;

/// Create a new queue.
#[post("/api/queues/create")]
pub async fn create_queue(name: String, description: Option<String>) -> Result<Queue, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        supervisor
            .send_message(SupervisorMessage::CreateQueue { name, description, reply: tx.into() })
...
pub async fn get_queue(id: String) -> Result<Option<Queue>, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let (tx, rx) = actors::concurrency::oneshot();
        supervisor
            .send_message(SupervisorMessage::GetQueue { queue_id, reply: tx.into() })
            .map_err(|e| ServerFnError::new(format!("Failed to send message: {}", e)))?;
...
pub async fn get_queue_by_name(name: String) -> Result<Option<Queue>, ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let (tx, rx) = actors::concurrency::oneshot();
        supervisor
            .send_message(SupervisorMessage::GetQueueByName { name, reply: tx.into() })
            .map_err(|e| ServerFnError::new(format!("Failed to send message: {}", e)))?;
...
pub async fn pause_queue(id: String) -> Result<(), ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let (tx, rx) = actors::concurrency::oneshot();
        supervisor
            .send_message(SupervisorMessage::PauseQueue { queue_id, reply: tx.into() })
            .map_err(|e| ServerFnError::new(format!("Failed to send message: {}", e)))?;
...
pub async fn resume_queue(id: String) -> Result<(), ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let (tx, rx) = actors::concurrency::oneshot();
        supervisor
            .send_message(SupervisorMessage::ResumeQueue { queue_id, reply: tx.into() })
            .map_err(|e| ServerFnError::new(format!("Failed to send message: {}", e)))?;
...
pub async fn delete_queue(id: String) -> Result<(), ServerFnError> {
    #[cfg(feature = "server")]
    {
        ...
        let (tx, rx) = actors::concurrency::oneshot();
        supervisor
            .send_message(SupervisorMessage::DeleteQueue { queue_id, reply: tx.into() })
            .map_err(|e| ServerFnError::new(format!("Failed to send message: {}", e)))?;
